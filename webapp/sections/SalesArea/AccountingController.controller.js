sap.ui.define([
    ...
    return Controller.extend("iffco.managecustomer.sections.SalesArea.AccountingController", {
        ...
        onAfterRendering: function (oEvent) {
            ...
            if (!that.CCA) {
                that.CCA = new sap.ui.xmlfragment("iffco.managecustomer.fragments.CreditControl", that);
        ...
        handleValueHelpDivisionSearch: function (evt) {
            ...
            if (sValue.length > 0) {
                ...
                filters.push(new sap.ui.model.Filter(sFilters, false));
                filters.push(new sap.ui.model.Filter("SalesOrg", "EQ", this.sOrgTitle));
                filters.push(new sap.ui.model.Filter("DistributionChannel", "EQ", this.distTitle));
        ...
        handleGenerateSales: function () {
            ...
            if (this.getView().getModel("appView").getProperty("/generateSale") === false) {
                ...
                MessageBox.information("Sales area has already been displayed");
            }
        ...
        handleValueHelpCCASearch: function (evt) {
            ...
            if (sValue.length > 0) {
                ...
                // this.CCA.getBinding("items").filter([new sap.ui.model.Filter("DistributionChannel", "EQ", val1)]);
            }
        },

        //Value Help for Price Group
        ...
        handleValueHelpTaxClassfnSearch: function (evt) {
            ...
            if (sValue.length > 0) {
                ...
                filters.push(new sap.ui.model.Filter(sFilters, false));
                if (this.taxCatTitle) {
                    filters.push(new sap.ui.model.Filter("Taxcategory", "EQ", this.taxCatTitle.split(" - ")[0]));
                }
                this.TaxClassfn.getBinding("items").filter(filters, true);
            } else {
                this.TaxClassfn.getBinding("items").filter([new sap.ui.model.Filter("Taxcategory", "EQ", this.taxCatTitle.split(" - ")[0])]);
            }
        },
