sap.ui.define(["sap/ui/core/mvc/Controller", 'sap/ui/model/Filter',
  'sap/ui/model/FilterOperator'], function (Controller, Filter, FilterOperator) {
    ...
    return Controller.extend(
      "iffco.managecustomer.sections.CustomerBasicDetails.BusinessDetailsController",
      {
        /**
         * @override
         */
        onInit: function () {
          if (!this.ChannelGrp) {
            this.ChannelGrp = new sap.ui.xmlfragment(
              "iffco.managecustomer.fragments.ChannelGrp",
              this
            );
          ...
          if (!this.subChannel) {
            this.subChannel = new sap.ui.xmlfragment(
              "iffco.managecustomer.fragments.SubChannel",
              this
            );
          ...
          if (!this.channel) {
            this.channel = new sap.ui.xmlfragment(
              "iffco.managecustomer.fragments.Channel",
              this
            );
          ...
          if (!this.lineOfBusinessType) {
            this.lineOfBusinessType = new sap.ui.xmlfragment(
              "iffco.managecustomer.fragments.LneOfBusinessType",
              this
            );
          ...
          if (!this.customerType) {
            this.customerType = new sap.ui.xmlfragment(
              "iffco.managecustomer.fragments.CustType",
              this
            );
          ...
          if (!this.customerInternalRating) {
            this.customerInternalRating = new sap.ui.xmlfragment(
              "iffco.managecustomer.fragments.CustInterRating",
              this
            );
        ...
        handleChannelGrp: function(evt){
          var val = evt.getSource().getValue;
          if(val){
            this.getView().byId("channelId").setValue();
            this.getView().byId("subChannelId").setValue();
            this.getView().byId("lobtId").setValue();
          }
        },
        handleChannel: function(evt){
          var val = evt.getSource().getValue;
          if(val){
            this.getView().byId("subChannelId").setValue();
            this.getView().byId("lobtId").setValue();
        ...
        handleValueHelpForChannelGrp: function (evt) {
          ...
          // this.ChannelGrp.getContent()[1].getBinding("items").filter([]);
